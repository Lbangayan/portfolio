...
function displayStats() {
  ...
  const maxFileLength = d3.max(fileStats, ([file, lines]) => lines);
  const longestFile = fileStats.find(([file, lines]) => lines === maxFileLength)[0];
  const avgFileLength = d3.mean(fileStats, ([file, lines]) => lines);
  ...
  dl.append('dd').text(avgFileLength.toFixed(2)); // Round to 2 decimal places
}
